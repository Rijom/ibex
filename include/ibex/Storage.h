...
/// @tparam Base Types of this class, or any derived types, can be stored inside
/// PolyStorage.
/// @tparam Size Maximal size of object that can be sorted.
/// @note Do not forget that every class put in here needs a virtual destructor
/// for destroy() to work properly.
